...
protoc greet/greetpb/greet.proto --go_out=./greet --go-grpc_out=./greet
# protoc greet/greetpb/greet.proto --go_out=plugins=grpc:./greet/
protoc calculator/calculatorpb/calculator.proto --go_out=./calculator --go-grpc_out=./calculator
